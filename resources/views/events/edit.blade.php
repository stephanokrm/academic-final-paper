...
<div class="row">
    <div class="col s12 m8 offset-m4 l8 offset-l4">
        {!! Form::open(['method'  => 'patch', 'route' => ['events.update', Crypt::encrypt($calendar_id), $event->getId()]]) !!}
        <div class="row">
            <div class="col s12 m6 l6">
                <label for="summary">Título</label>
                <input id="summary" type="text" class="validate" name="summary" value="{{ $event->getSummary() }}">
        ...
        <div class="row">
            <div class="col s12 m12 l12">
                <p>
                    {!! Form::checkbox('all_day', 'Y', $event->isAllDay() == true ? true : false, ['id' => 'all_day']) !!}
        ...
        <div class="row">
            <div class="col s12 m3 l3 date_col">
                ...
                <input id="begin-date" type="date" class="datepicker date" name="begin_date" value="{{ $event->getBeginDate() }}">
            ...
            <div class="col s12 m3 l3 hide_time">
                ...
                <input id="begin-time" type="text" class="validate time" name="begin_time" value="{{ $event->getBeginTime() }}">
        ...
        <div class="row">
            <div class="col s12 m3 l3 date_col">
                ...
                <input id="end-date" type="date" class="datepicker date" name="end_date" value="{{ $event->getEndDate() }}">
            ...
            <div class="col s12 m3 l3 hide_time">
                ...
                <input id="end-time" type="text" class="validate time" name="end_time" value="{{ $event->getEndTime() }}">
        ...
        <div class="row">
            <div class="col s12 m6 l6">
                ...
                <textarea length="500" id="description" name="description">{{ $event->getDescription() }}</textarea>
        ...
        <div class="row">
            <div class="col s12 m6 l6">
                ...
                {!! Form::radio('color', $id, $event->getColorId() == $id ? true : false, ['id' => 'color_' . $id, 'class' => 'square']) !!}
