...
@section('content')
    ...
    <div class="row calendars-list">
        <div class="col s12 m4 offset-m4 l4 offset-l4">
            <ul class="collection">
                <li class="collection-item"><i class="material-icons left small">portrait</i> {{ Session::get('user')->nome_completo }}</li>
                <li class="collection-item"><i class="material-icons left small">security</i> {{ Session::get('user')->matricula }}</li>
                <li class="collection-item"><i class="material-icons left small">mail</i> {{ Session::get('user')->email }}</li>
                <li class="collection-item"><i class="fa fa-google fa-2x" aria-hidden="true"></i> {{ Session::get('user')->googleEmail->email }}</li>
            </ul>
        </div>
    </div>
